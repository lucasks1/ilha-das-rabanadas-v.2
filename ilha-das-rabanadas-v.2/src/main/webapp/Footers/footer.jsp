...
#img3{
	...
	<div class="container-fluid  border border-top-3 border-dark "
		id="footer">
		<footer
			class="row row-cols-3 row-cols-sm-2 row-cols-md-5 justify-content-center py-5 align-items-center">
			<div class="col">
				<img id="img3" width="70%" src="../public/imgs/img/logo-footer.webp" alt="">
			</div>
			...
			<div class="col">
				...
				<ul class="nav gap-5 ">
					<li class="nav-item mb-2 fs-2"><a target="_blank"
						href="https://www.instagram.com/ilhadasrabanadas_/"
